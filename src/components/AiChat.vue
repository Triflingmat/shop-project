...
const GREETING = '你好！我是优选商城的智能客服，有什么可以帮你的吗？'
const SUGGESTIONS = ['查看商品', '管理我的订单', '查看售后','如何查看购物车']
...
.ai-chat-fab {
  ...
  box-shadow: 0 4px 20px rgba(228, 57, 60, .5);
  display: flex;
  align-items: center;
...
.ai-chat-fab:hover {
  transform: scale(1.1);
  box-shadow: 0 6px 28px rgba(228, 57, 60, .65);
}
...
.chat-input :deep(.el-textarea__inner:focus) {
  border-color: #e4393c;
  box-shadow: 0 0 0 1px rgba(228, 57, 60, .2);
}
...
.send-btn {
  ...
  width: 36px;
  height: 36px;
  --el-button-bg-color: #e4393c !important;
  --el-button-border-color: #e4393c !important;
  --el-button-hover-bg-color: #c1272d !important;
  --el-button-hover-border-color: #c1272d !important;
  --el-button-active-bg-color: #a91d22 !important;
  --el-button-active-border-color: #a91d22 !important;
}

/* 禁用态 */
.send-btn.is-disabled {
  --el-button-bg-color: #f7b8ba !important;
  --el-button-border-color: #f7b8ba !important;
  --el-button-text-color: #fef0f0 !important;
  --el-button-disabled-bg-color: #f7b8ba !important;
  --el-button-disabled-border-color: #f7b8ba !important;
  --el-button-disabled-text-color: #fef0f0 !important;
  opacity: 1 !important;
}
